 ...
 *
 */
public class CtCountData extends LightEntity implements java.io.Serializable {
	...
	public CtCountData(CtCountDataId id, int periodSec) {
		this.id = id;
		this.periodSec = periodSec;
	}

	public CtCountData(CtCountDataId id, int periodSec, Integer count, Integer countLong, Double occupancy,
