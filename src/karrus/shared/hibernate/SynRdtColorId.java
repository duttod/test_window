...
/**
 * SynRdtColorId generated by hbm2java.
 *
 ...
 *
 */
public class SynRdtColorId extends LightEntity implements java.io.Serializable {

	private String synopticId;
	private String itemId;

	public SynRdtColorId() {
	}

	public SynRdtColorId(String synopticId, String itemId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SynRdtColorId))
			return false;
		SynRdtColorId castOther = (SynRdtColorId) other;
