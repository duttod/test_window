...
/**
 * AlAlarmOpenedId generated by hbm2java.
 *
 ...
 *
 */
public class AlAlarmOpenedId extends LightEntity implements java.io.Serializable {

	private Date openingTimestamp;
	private String type;
	private String source;

	public AlAlarmOpenedId() {
	}

	public AlAlarmOpenedId(Date openingTimestamp, String type, String source) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlAlarmOpenedId))
			return false;
		AlAlarmOpenedId castOther = (AlAlarmOpenedId) other;
