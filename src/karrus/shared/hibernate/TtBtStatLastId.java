...
/**
 * TtBtStatLastId generated by hbm2java.
 *
 ...
 *
 */
public class TtBtStatLastId extends LightEntity implements java.io.Serializable {

	private Date timestamp;
	private String origin;
	private String destination;

	public TtBtStatLastId() {
	}

	public TtBtStatLastId(Date timestamp, String origin, String destination) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TtBtStatLastId))
			return false;
		TtBtStatLastId castOther = (TtBtStatLastId) other;
