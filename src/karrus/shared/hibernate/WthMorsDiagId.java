...
/**
 * WthMorsDiagId generated by hbm2java.
 *
 ...
 *
 */
public class WthMorsDiagId extends LightEntity implements java.io.Serializable {

	private Date timestamp;
	private String station;

	public WthMorsDiagId() {
	}

	public WthMorsDiagId(Date timestamp, String station) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WthMorsDiagId))
			return false;
		WthMorsDiagId castOther = (WthMorsDiagId) other;
