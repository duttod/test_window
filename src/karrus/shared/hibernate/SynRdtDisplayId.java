...
/**
 * SynRdtDisplayId generated by hbm2java.
 *
 ...
 *
 */
public class SynRdtDisplayId extends LightEntity implements java.io.Serializable {

	private String synopticId;
	private String itemId;

	public SynRdtDisplayId() {
	}

	public SynRdtDisplayId(String synopticId, String itemId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SynRdtDisplayId))
			return false;
		SynRdtDisplayId castOther = (SynRdtDisplayId) other;
