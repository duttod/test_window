...
/**
 * SynWeatherStationId generated by hbm2java.
 *
 ...
 *
 */
public class SynWeatherStationId extends LightEntity implements java.io.Serializable {

	private String synopticId;
	private String itemId;

	public SynWeatherStationId() {
	}

	public SynWeatherStationId(String synopticId, String itemId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SynWeatherStationId))
			return false;
		SynWeatherStationId castOther = (SynWeatherStationId) other;
