 ...
 */
public class WeatherStatesTimeSeriesPlot extends Composite {
	...
	public WeatherStatesTimeSeriesPlot(Composite container, int width, int height, PlotType plotType, boolean isZoomEnabled) {
		this(container, width, height, null, null, plotType, isZoomEnabled, false, false);
	}
	public WeatherStatesTimeSeriesPlot(Composite container, int width, int height, PlotType plotType, boolean isZoomEnabled, boolean isMultipleAxis, boolean isPlotWithInteractivLegend) {
		this(container, width, height, null, null, plotType, isZoomEnabled, isMultipleAxis, isPlotWithInteractivLegend);
	}
	public WeatherStatesTimeSeriesPlot(Composite container, String title, int width, int height, PlotType plotType, boolean isZoomEnabled, boolean isMultipleAxis, boolean isPlotWithInteractivLegend) {
		this(container, title, width, height, null, null, plotType, isZoomEnabled, false, isMultipleAxis, isPlotWithInteractivLegend);
	}
	public WeatherStatesTimeSeriesPlot(Composite container, String title, int width, int height, PlotType plotType, boolean isZoomEnabled, boolean isLegendShownOnGraph) {
		this(container, title, width, height, null, null, plotType, isZoomEnabled, isLegendShownOnGraph, false, false);
	}
	public WeatherStatesTimeSeriesPlot(Composite container, String title, int width, int height, PlotType plotType, boolean isZoomEnabled, boolean isLegendShownOnGraph, boolean isMultipleAxis, boolean isPlotWithInteractivLegend) {
	...
	public WeatherStatesTimeSeriesPlot(Composite container, int width, int height, Date minDate, Date maxDate, PlotType plotType, boolean isZoomEnabled, boolean isMultipleAxis, boolean isPlotWithInteractivLegend) {
		this(container, "", width, height, minDate, maxDate, plotType, isZoomEnabled, false, isMultipleAxis, isPlotWithInteractivLegend);
	}

	public WeatherStatesTimeSeriesPlot(Composite container, String title, int width, int height, Date minDate, Date maxDate, PlotType plotType, boolean isZoomEnabled, boolean isLegendShownOnGraph, boolean isMultipleAxis, boolean isPlotWithInteractivLegend) {
		...
		for (TimeSeries timeSeries : timeSeriesInfos.keySet()){
			...
			if (!axis.contains(timeSeriesInfo.getyAxis())) {
				...
				if (timeSeriesInfos.size()==1) {
					...
					if (timeSeriesInfo.getyAxis() == 3) {
						axisOptionY.setPosition(AxisPosition.RIGHT);
					} else {
						axisOptionY.setPosition(AxisPosition.LEFT);
					}
				}	
				axisOptionY.setColor(timeSeriesInfo.getColor());
				if (timeSeriesInfo.getTicks() != null) {
					axisOptionY.setTicks(timeSeriesInfo.getTicks());
				}
	...
	public void addTimeSeries(TimeSeries timeSerie, String legendTitle, String color, String yLabel, double minValue, double maxValue, String dataUnit, PlotClickMessageFormatter plotClickMessageFormatter, 
			                  PlotType plotType, boolean isMarking) {
