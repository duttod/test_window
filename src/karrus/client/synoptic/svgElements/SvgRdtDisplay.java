...
public class SvgRdtDisplay extends SvgElement {

	private SynRdtDisplay synRdtDisplay;
	
	public SvgRdtDisplay(SynRdtDisplay synRdtDisplay, String item, String synoptic) {
		super(item, synoptic, false);
		this.synRdtDisplay = synRdtDisplay;
	}
	...
	public SynRdtDisplay getSynRdtDisplays() {
		return synRdtDisplay;
	}
}
