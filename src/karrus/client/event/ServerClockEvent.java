 ...
 */
package karrus.client.event;

import de.novanic.eventservice.client.event.Event;
import de.novanic.eventservice.client.event.domain.Domain;
import de.novanic.eventservice.client.event.domain.DomainFactory;

public class ServerClockEvent implements Event {
     ...
     */
    public ServerClockEvent() {}

    public ServerClockEvent(String aServerGeneratedMessage) {
    ...
    public String toString() {
        ...
        theStringBuilder.append(ServerClockEvent.class.getName());
